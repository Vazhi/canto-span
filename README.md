...
- per-construction assertions: **1,191**
- construction test files: **169**

v0.5.192 audits eleven result and change-state wrappers. Ten zero-weight implementation probes preserve complete-output reachability; `PerfectiveResultPredicate` remains explicitly shadowed by `PerfectiveVP`. No recognized parser span or linguistic status changed.
