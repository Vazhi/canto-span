...
const results = [];
const failures = [];
const coverage = { positive_and_boundary: 0, positive_only: 0, boundary_only: 0, implementation_positive_only: 0, compatibility_alias_only: 0, no_direct_cases: 0 };
let executed = 0;
...
const outputPath = path.join(root, "validation", "current", "construction-tests.json");
