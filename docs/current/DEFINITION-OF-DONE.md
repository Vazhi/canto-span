...
- [ ] **Two independent native speakers.** The same relevant positive and negative contrasts have been judged by at least two speakers who did not consult each other. A single speaker's judgments are recorded but do not satisfy this item on their own. Public-form submissions count only after native-language background, independence, completeness, consent, duplicate screening, and manual response adjudication are recorded; submission or self-identification alone is insufficient. A response may be retained as lower-tier panel evidence without being promotion-eligible when the instrument has material design defects. Construction notes must distinguish total counted speaker evidence from `promotion_eligible_independent_speaker_count`.
...
- A large response count from an instrument that does not isolate the relevant grammatical or interpretive contrast.
