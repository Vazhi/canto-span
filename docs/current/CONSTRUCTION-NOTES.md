...
The union of those status directories is the canonical 163-note construction registry. A note must not be copied into more than one folder.
...
- exactly 163 current construction notes;
- exactly 2 workflow-active and 161 workflow-archived notes;
