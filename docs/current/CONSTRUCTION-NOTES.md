...
The union of those status directories is the canonical 162-note construction registry. A note must not be copied into more than one folder.
...
- exactly 162 current construction notes;
- exactly 2 workflow-active and 160 workflow-archived notes;
