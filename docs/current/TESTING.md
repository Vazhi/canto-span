...
- 1,278 per-construction assertions across 161 construction files.

Current coverage is 8 positive-and-boundary, 104 positive-only, 48 implementation-only, and 1 compatibility-alias-only. No active label is uncovered.
