...
- 1,287 per-construction assertions across 160 construction files.

Current coverage is 11 positive-and-boundary, 104 positive-only, 44 implementation-only, and 1 compatibility-alias-only. No active label is uncovered.
