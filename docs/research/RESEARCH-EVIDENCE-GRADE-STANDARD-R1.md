...
```text
RUNTIME-001	RUNTIME_OBSERVATION_ONLY	VERIFIED_DIRECT_LOCAL_OBSERVATION	Runtime 0.5.214 probe, rows 1-8	Documents current false coverage.	Zero linguistic-evidence weight.	USE_FOR_COLLISION_AUDIT_ONLY
```
