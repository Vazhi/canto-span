...
- `covered_main`: **623**
- `covered_variant`: **0**
- `handled_structurally`: **179**
- `surface_covered_sense_uncertain`: **24**
- `missing`: **833**
- `manual_review`: **341**

## R6 candidate additions (19)
...
Unlike noun-only batches, stative lexicalization can activate existing predicate templates. Any regression that indicates a semantically wrong parse is grounds to remove the triggering lexeme rather than rebaseline the grammar.
