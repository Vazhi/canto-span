...
- `covered_main`: **579**
- `covered_variant`: **0**
- `handled_structurally`: **170**
- `surface_covered_sense_uncertain`: **24**
- `missing`: **886**
- `manual_review`: **341**

## R4 same-task lexical additions (35)
...
| 650 | 發展 | 43 | faat3zin2 | development/growth/to develop/to grow/to expand |
| 653 | 賺 | 43 | zaan6 | to earn/to make a profit |

## Interpretation

The audit still separates lexical opportunity from grammatical authorization. Remaining particles, result/directional material, highly polyfunctional predicates, spelling variants, and generated corpus strings remain unresolved unless they can be added without changing protected parser behavior.
