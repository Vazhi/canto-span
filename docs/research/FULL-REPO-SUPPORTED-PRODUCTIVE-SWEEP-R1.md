...
| `role_neutral_panel_threshold` | 3 |
...
| `AA93` | `OvertDestinationMotionVP` | `narrowing_candidate` | DirectionalMotionAndGoals | SRC-CHOR-2018-DIRECTIONALS, SRC-LEUNG-2026-MOTION, SRC-SZETO-2015-PERFECTIVE | source-bounded subtype review |
...
| `AA51` | `DisposalChangeIntoResultFrame` | `retired_evidence_rehome_candidate` | ResultativeAndChangePredication | SRC-MATTHEWS-YIP-2011-ASPECT-MULTIMEDIA, SRC-ZHENG-ZHANG-GAO-2021-HK-CANTONESE-COURSE | disposal/modal composition plus ChangeIntoPredicate |
| `AA54` | `EvaluationWithDouSyun` | `retired_evidence_rehome_candidate` | ScalarComparisonAndEvaluation | SRC-LAM-2014-SURPASS-COMPARATIVE, SRC-ZHENG-ZHANG-GAO-2021-HK-CANTONESE-COURSE, SRC-WORDSHK-SYUN3, SRC-POLYU-TAI-O-837295 | ScalarEvaluation plus independently represented focus |
...
| `AA92` | `MotionPurposeDelimitedCompositeWrapper` | `retired_evidence_rehome_candidate` | PurposeAndAspectRepresentation | SRC-MATTHEWS-2006-SVC, SRC-WONG-2023-LANGUAGE-SAMPLE | typed purpose relation plus DelimitedVP |
...
| `AB25` | `PossessiveNominalCompositeWrapper` | `retired_evidence_rehome_candidate` | PossessiveNominalRepresentation | SRC-LAM-LAU-LEE-2024-SEGMENTATION, SRC-SIO-2011-GE3, SRC-XIA-2025-CLASSIFIERS | PossessiveNominals subtype research |
| `AB26` | `HeadlessPossessiveFragmentCompositeWrapper` | `retired_evidence_rehome_candidate` | PossessiveAndFragmentRepresentation | SRC-SIO-2011-GE3, SRC-YIP-MATTHEWS-2000-BASIC | headless possessive nominal + fragment/discourse analysis |
| `AB27` | `PossessionTransferCompositeWrapper` | `retired_evidence_rehome_candidate` | PossessionAndTransferRepresentation | SRC-YIP-MATTHEWS-2000-BASIC | possession and transfer constructions represented independently |
| `AB29` | `PostposedExistentialQuestion` | `retired_evidence_rehome_candidate` | ExistentialQuestions | SRC-YIP-MATTHEWS-2000-BASIC | ExistentialQuestion plus direct postposed-form research |
| `AB37` | `ProgressivePlaceQuestion` | `retired_evidence_rehome_candidate` | TypedWhAndStanceQuestions | SRC-ALDERETE-ETAL-2017-SYNOPSIS, SRC-LIANG-MAI-2026-GRAMMAR-CODING | ProgressiveVP plus locative-wh question structure |
| `AB38` | `ProgressivePurposeClause` | `retired_evidence_rehome_candidate` | PurposeSerialRelations | SRC-CHOR-2018-DIRECTIONALS, SRC-LAM-BODOMO-2003-VERB-ORDER, SRC-MATTHEWS-2006-SVC | progressive aspect plus independently licensed purpose relations |
| `AB39` | `ProgressiveTransitivePredicate` | `retired_evidence_rehome_candidate` | ProgressiveAspect | SRC-ALDERETE-ETAL-2017-SYNOPSIS, SRC-FAN-2024-JAU-VP-ASPECT | ProgressiveVP |
