---
title: "CognitionContentFrame"
type: "canto-span-construction"
construction: "CognitionContentFrame"
...
standard_test_file: "tests/constructions/CognitionContentFrame.json"
...
Cantonese may instantiate the structural family represented by CognitionContentFrame; exact productivity and boundaries require pattern-specific independent evidence.
...
- Locator: p. 29, section 4.4 example (76)
- Verification: `VERIFIED_FULL_TEXT`
- What it supports: The synopsis states cognition verbs can take clausal complements and gives a specific 覺得 example.
- Limit: Do not infer that every cognition-tagged token selects every clause type.
...
- Locator: abstract and sections 1/3/5
- Verification: `VERIFIED_AUTHOR_ACCEPTED_PREPRINT`
- What it supports: Lui identifies a dedicated reported-thought construction and separates it from 話 reported speech.
- Limit: Do not merge all mental-content constructions.
...
- What it supports: The source distinguishes neutral lexical meaning, doubt, and negative-attitude uses for closely related forms.
- Limit: Do not collapse pragmatic stance into factual cognition.
...
- Standard executable test file: `tests/constructions/CognitionContentFrame.json`
...
- Research question: Which externally documented Cantonese constructions, if any, justify the scope and boundaries currently represented by CognitionContentFrame?
