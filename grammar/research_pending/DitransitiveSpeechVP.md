...
- Retained profile: the exact source-linked `話 + recipient + 知` sequence in `我唔話你知。`
- Boundaries exclude speech-verb and cognition-predicate substitutions.
- The label remains `research_pending`; the evidence does not license unrestricted lexical combinations or settle a ditransitive/serial analysis.
