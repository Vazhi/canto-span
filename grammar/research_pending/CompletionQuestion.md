---
title: "CompletionQuestion"
type: "canto-span-construction"
construction: "CompletionQuestion"
...
standard_test_file: "tests/constructions/CompletionQuestion.json"
...
Cantonese may instantiate the structural family represented by CompletionQuestion; exact productivity and boundaries require pattern-specific independent evidence.
...
- What it supports: The description explicitly attributes the reading to visible completion/result particles or aspect markers and illustrates only such licensed predicates.
- Limit: Do not treat absence of support as proof that every bare-VP+未 string is impossible; the conclusion is a parser-authorization boundary, not a universal ungrammaticality claim.
...
- Standard executable test file: `tests/constructions/CompletionQuestion.json`
...
- Research question: Which externally documented Cantonese constructions, if any, justify the scope and boundaries currently represented by CompletionQuestion?
