...
standard_executable_test_count: 44
...
Cantonese may instantiate the structural family represented by QuantifiedClassifierNP; exact productivity and boundaries require pattern-specific independent evidence.
...
- Locator: pp. 61-62; Table 1; ex. 1b
- Verification: `VERIFIED_FULL_TEXT`
- What it supports: X-C-N is one of four explicit Cantonese NP schemata; 一個蘋果 illustrates the order.
- Limit: Do not infer that every measure expression is a classifier NP, that classifier choice is unrestricted, or that the cited constituent analysis is uniquely settled.
...
- Locator: p. 11998; example 1
- Verification: `VERIFIED_FULL_TEXT`
- What it supports: 佢有兩本 is accepted as “he has two (books),” while a bare numeral without a classifier does not license the same quantity reading.
- Limit: Do not treat a bare numeral as equivalent, invent an antecedent, or conflate noun ellipsis with a full overt-head NP.
...
- Locator: p. 8; ellipsis test following example 14
- Verification: `VERIFIED_FULL_TEXT`
- What it supports: Head nouns in Num-CL-N can be elided while classifiers cannot; Cantonese is stated not to differ from Mandarin on this diagnostic.
- Limit: Do not treat a bare numeral as equivalent, invent an antecedent, or conflate noun ellipsis with a full overt-head NP.
...
- Research question: Which externally documented Cantonese constructions, if any, justify the scope and boundaries currently represented by QuantifiedClassifierNP?
