---
title: "DegreeStativePredicate"
type: "canto-span-construction"
construction: "DegreeStativePredicate"
...
standard_test_file: "tests/constructions/DegreeStativePredicate.json"
standard_test_coverage: "positive_and_boundary"
standard_positive_test_count: 21
standard_boundary_test_count: 2
standard_implementation_probe_count: 0
standard_executable_test_count: 23
...
Cantonese may instantiate the structural family represented by DegreeStativePredicate; exact productivity and boundaries require pattern-specific independent evidence.
...
- What it supports: Predicative adjectives are described as verb-like, copula-less, and degree-modified in neutral predication.
- Limit: Do not infer that discourse can never license an unmodified property word.
...
- Locator: p. 6 lines/examples for 好 悶 and 非常 好
- Verification: `VERIFIED_FULL_TEXT`
- What it supports: The annotation treats degree markers as separate words rather than subparts of the following adjective.
- Limit: Do not infer that orthographic spacing exists in ordinary Cantonese writing or fixes the full syntactic analysis.
...
- Standard executable test file: `tests/constructions/DegreeStativePredicate.json`
...
- Research question: Which externally documented Cantonese constructions, if any, justify the scope and boundaries currently represented by DegreeStativePredicate?
