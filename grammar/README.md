...
| [`unsupported_generalization/`](./unsupported_generalization/) | 78 | The current broad claim has no defensible supported scope. |
...
| [`retired/`](./retired/) | 17 | Labels removed from the active runtime registry; this folder is a navigation index, not a second status owner. |
