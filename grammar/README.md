...
| [`unsupported_generalization/`](./unsupported_generalization/) | 74 | The current broad claim has no defensible supported scope. |
...
| [`retired/`](./retired/) | 20 | Labels removed from the active runtime registry; this folder is a navigation index, not a second status owner. |
