...
| [`research_pending/`](./research_pending/) | 61 | A concrete linguistic question exists, but provisional requirements are incomplete. |
| [`unsupported_generalization/`](./unsupported_generalization/) | 82 | The current broad claim has no defensible supported scope. |
