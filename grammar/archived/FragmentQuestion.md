---
title: "FragmentQuestion"
type: "canto-span-construction"
construction: "FragmentQuestion"
...
standard_test_file: "tests/constructions/FragmentQuestion.json"
standard_test_coverage: "positive_only"
standard_positive_test_count: 2
standard_boundary_test_count: 0
standard_executable_test_count: 2
source_ids: ["SRC-LI-2006-FINAL-PARTICLES"]
runtime_active: true
...
Cantonese may instantiate the structural family represented by FragmentQuestion; exact productivity and boundaries require pattern-specific independent evidence.
...
- Locator: printed pp. 94-95
- Verification: `VERIFIED_PUBLISHER_FULL_TEXT`
- What it supports: The author proposes an evaluative marker generally and a topic-marker function in thematic questions.
- Limit: Do not import the dissertation’s cartographic projections or silent derivation into Canto Span.
...
- Standard executable test file: `tests/constructions/FragmentQuestion.json`
...
- Research question: Which externally documented Cantonese constructions, if any, justify the scope and boundaries currently represented by FragmentQuestion?
