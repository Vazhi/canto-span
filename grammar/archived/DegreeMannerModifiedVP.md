---
title: "DegreeMannerModifiedVP"
type: "canto-span-construction"
construction: "DegreeMannerModifiedVP"
...
standard_test_file: "tests/constructions/DegreeMannerModifiedVP.json"
...
Cantonese may instantiate the structural family represented by DegreeMannerModifiedVP; exact productivity and boundaries require pattern-specific independent evidence.
...
- What it supports: Punctuation and discourse interpretation separate 靜啲 from the following clause.
- Limit: Do not wrap across clause or intonational boundaries.
...
- What it supports: A postverbal expression is attested separately from preposed 快啲行上去.
- Limit: Do not derive one order from the other or assign identical syntax/pragmatics without evidence.
...
- Standard executable test file: `tests/constructions/DegreeMannerModifiedVP.json`
- Implementation-only reachability: `REACH-003` emits this label for `快啲嚟。`; linguistic evidence weight is **0**; provenance: `test-data/pre-intermediate-gold-corpus.tsv#PI-ADJ-007`.
...
- Research question: Which externally documented Cantonese constructions, if any, justify the scope and boundaries currently represented by DegreeMannerModifiedVP?
