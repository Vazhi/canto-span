...
- Implementation-only reachability: `STCWRAP-002` with `我諗住返屋企。`
- The probe protects the exact subject + 諗住 + motion-VP route only. Polysemy and subjectless routing remain unresolved.
