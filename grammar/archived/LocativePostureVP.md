...
- Implementation-only reachability: `REACH-007` emits this label for `佢坐喺度。`; linguistic evidence weight is **0**; provenance: `test-data/pre-intermediate-gold-corpus.tsv#PI-VP-010`.
