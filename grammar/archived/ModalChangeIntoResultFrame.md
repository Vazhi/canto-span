---
title: "ModalChangeIntoResultFrame"
type: "canto-span-construction"
construction: "ModalChangeIntoResultFrame"
...
standard_test_file: "tests/constructions/ModalChangeIntoResultFrame.json"
...
Cantonese may instantiate the structural family represented by ModalChangeIntoResultFrame; exact productivity and boundaries require pattern-specific independent evidence.
...
- Locator: exact coursebook clause
- Verification: `VERIFIED_USER_PROVIDED_FULL_TEXT_AND_OFFICIAL_PUBLISHER_METADATA`
- What it supports: Topic, modal, change predicate, and complement remain overt and compositionally recoverable.
- Limit: Do not preserve a language label solely for convenience.
...
- Standard executable test file: `tests/constructions/ModalChangeIntoResultFrame.json`
...
- Research question: Which externally documented Cantonese constructions, if any, justify the scope and boundaries currently represented by ModalChangeIntoResultFrame?
...
- Implementation-only reachability: `RESCHG-002A`.
