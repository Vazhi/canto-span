---
title: "ComparativeStative"
type: "canto-span-construction"
construction: "ComparativeStative"
...
Cantonese may instantiate the structural family represented by ComparativeStative; exact productivity and boundaries require pattern-specific independent evidence.
...
- Locator: pp. 375-376; examples (31)-(32)
- Verification: `VERIFIED_OFFICIAL_FULL_TEXT`
- What it supports: Cantonese has at least distinct overt comparative strategies rather than one generic ComparativeStative node.
- Limit: Do not call every X啲 sequence comparative without scalar and contextual evidence.
...
- Locator: user PDF p. 171; inherited PDF pp. 40-41
- Verification: `VERIFIED_USER_PROVIDED_FULL_TEXT_AND_OFFICIAL_PUBLISHER_METADATA`
- What it supports: Post-predicate 啲 can express a scalar difference in a property-predicate context.
- Limit: Do not infer free attachment to every stative or identical meaning in every position.
...
- Standard executable test file: `tests/constructions/ComparativeStative.json`
...
- Research question: Which externally documented Cantonese constructions, if any, justify the scope and boundaries currently represented by ComparativeStative?
