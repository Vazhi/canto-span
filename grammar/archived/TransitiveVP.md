...
standard_positive_test_count: 29
standard_boundary_test_count: 0
standard_executable_test_count: 29
...
Cantonese may instantiate the structural family represented by TransitiveVP; exact productivity and boundaries require pattern-specific independent evidence.
...
- Locator: printed p. 37, simple VP inventory
- Verification: `VERIFIED_FULL_TEXT`
- What it supports: The synopsis distinguishes transitive and ditransitive VP schemata.
- Limit: Do not assign transitivity to every action_verb or every verb followed by nominal material.
...
- Locator: official PDF pp. 51-52, lines 1848-1889
- Verification: `VERIFIED_FULL_TEXT`
- What it supports: The source’s descriptive categories cross several predicate and argument types.
- Limit: Do not treat NP, proposition, recipient, theme, predicative nominal, and existential pivot as equivalent objects.
...
- Research question: Which externally documented Cantonese constructions, if any, justify the scope and boundaries currently represented by TransitiveVP?
