...
- Implementation-only reachability: `ESQWRAP-009` with `係時候返屋企。`
- Protects the current 係時候 + action route only. No verified exact source currently establishes the dedicated wrapper.
