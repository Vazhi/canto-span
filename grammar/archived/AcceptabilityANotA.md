...
- Implementation-only reachability: `REACH-001` emits this label for `得唔得？`; linguistic evidence weight is **0**; provenance: `test-data/cp021b-lx1-construction-freeze-baseline.json#cases[407].context_source`.
