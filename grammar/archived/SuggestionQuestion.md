---
title: "SuggestionQuestion"
type: "canto-span-construction"
construction: "SuggestionQuestion"
...
Cantonese may instantiate the structural family represented by SuggestionQuestion; exact productivity and boundaries require pattern-specific independent evidence.
...
- Locator: Lesson 6 examples 佢身體唔好…不如我哋…, 佢咁忙…不如我哋…
- Verification: `VERIFIED_USER_PROVIDED_FULL_TEXT_AND_OFFICIAL_PUBLISHER_METADATA`
- What it supports: The preceding material motivates the proposal but is not necessarily a dedicated discourse-marker token.
- Limit: Do not collapse arbitrary preceding clauses into one optional discourse-marker slot.
...
- Research question: Which externally documented Cantonese constructions, if any, justify the scope and boundaries currently represented by SuggestionQuestion?
