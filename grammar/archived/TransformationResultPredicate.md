---
title: "TransformationResultPredicate"
type: "canto-span-construction"
construction: "TransformationResultPredicate"
...
standard_test_file: "tests/constructions/TransformationResultPredicate.json"
...
Cantonese may instantiate the structural family represented by TransformationResultPredicate; exact productivity and boundaries require pattern-specific independent evidence.
...
- What it supports: Aspect must be separated from lexical change and complement-linking analysis.
- Limit: Do not infer transformation semantics from 咗.
...
- What it supports: Related change semantics do not establish interchangeability between 變成 and 變咗做.
- Limit: Do not replace one sequence with the other or infer equal distribution.
...
- Standard executable test file: `tests/constructions/TransformationResultPredicate.json`
...
- Research question: Which externally documented Cantonese constructions, if any, justify the scope and boundaries currently represented by TransformationResultPredicate?
...
- Implementation-only reachability: `RESCHG-005B`.
