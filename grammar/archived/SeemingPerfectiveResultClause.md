---
title: "SeemingPerfectiveResultClause"
type: "canto-span-construction"
construction: "SeemingPerfectiveResultClause"
...
standard_test_file: "tests/constructions/SeemingPerfectiveResultClause.json"
...
Cantonese may instantiate the structural family represented by SeemingPerfectiveResultClause; exact productivity and boundaries require pattern-specific independent evidence.
...
- What it supports: Aspect support does not validate 好似 scope or weather valency.
- Limit: Do not use aspect evidence as whole-clause support.
...
- Locator: coursebook entries and dialogues; inherited locators
- Verification: `VERIFIED_USER_PROVIDED_FULL_TEXT_AND_OFFICIAL_PUBLISHER_METADATA`
- What it supports: Component legitimacy does not establish their exact six-part combination or attachment.
- Limit: Do not infer one constituent structure from co-occurrence.
...
- Standard executable test file: `tests/constructions/SeemingPerfectiveResultClause.json`
...
- Research question: Which externally documented Cantonese constructions, if any, justify the scope and boundaries currently represented by SeemingPerfectiveResultClause?
...
- Implementation-only reachability: `RESCHG-006A`.
