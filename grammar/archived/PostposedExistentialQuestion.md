---
title: "PostposedExistentialQuestion"
type: "canto-span-construction"
construction: "PostposedExistentialQuestion"
...
standard_test_file: "tests/constructions/PostposedExistentialQuestion.json"
...
Cantonese may instantiate the structural family represented by PostposedExistentialQuestion; exact productivity and boundaries require pattern-specific independent evidence.
...
- What it supports: The sourced standard polar form is 有冇 before the questioned domain.
- Limit: Do not claim the reference rejects postposed 有…冇; it simply does not establish it here.
...
- Standard executable test file: `tests/constructions/PostposedExistentialQuestion.json`
...
- Research question: Which externally documented Cantonese constructions, if any, justify the scope and boundaries currently represented by PostposedExistentialQuestion?
...
- Implementation-only reachability: `ESQWRAP-010` with `有書冇？`
- Protects the current postposed existential-question route only. Checked reference evidence establishes preverbal 有冇 instead.
