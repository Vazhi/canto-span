...
standard_test_file: "tests/constructions/Comment.json"
...
Canto Span does not claim that Comment is a canonical Cantonese construction name; it is an internal structural representation.
...
- Standard executable test file: `tests/constructions/Comment.json`
