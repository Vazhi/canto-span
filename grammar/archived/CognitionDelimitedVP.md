---
title: "CognitionDelimitedVP"
type: "canto-span-construction"
construction: "CognitionDelimitedVP"
...
standard_test_file: "tests/constructions/CognitionDelimitedVP.json"
standard_test_coverage: "implementation_positive_only"
standard_positive_test_count: 0
standard_boundary_test_count: 0
standard_implementation_probe_count: 1
standard_executable_test_count: 1
source_ids: ["SRC-SIO-BOND-2025", "SRC-ZHENG-ZHANG-GAO-2021-HK-CANTONESE-COURSE"]
runtime_active: true
...
Cantonese may instantiate the structural family represented by CognitionDelimitedVP; exact productivity and boundaries require pattern-specific independent evidence.
...
- Locator: pp. 6-7 selectional restrictions
- Verification: `VERIFIED_FULL_TEXT`
- What it supports: The marker’s distribution is not a free action-verb cross-product.
- Limit: Do not promote the whole cognition-predicate category from one 諗 example.
...
- Locator: printed p. 215
- Verification: `VERIFIED_USER_PROVIDED_FULL_TEXT_AND_OFFICIAL_PUBLISHER_METADATA`
- What it supports: Cognition + 下 is attested with following polar-clausal content, not only as an isolated two-token VP.
- Limit: Do not force the utterance into an objectless cognition-only node.
...
- Standard executable test file: `tests/constructions/CognitionDelimitedVP.json`
...
- Research question: Which externally documented Cantonese constructions, if any, justify the scope and boundaries currently represented by CognitionDelimitedVP?
...
- Implementation-only reachability: `EXPDEL-005`.
