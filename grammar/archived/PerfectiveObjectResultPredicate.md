...
standard_test_file: "tests/constructions/PerfectiveObjectResultPredicate.json"
...
- Standard executable test file: `tests/constructions/PerfectiveObjectResultPredicate.json`
...
- Implementation-only reachability: `RESCHG-006B`.
