---
title: "NegativePotentialComplement"
type: "canto-span-construction"
construction: "NegativePotentialComplement"
...
standard_test_file: "tests/constructions/NegativePotentialComplement.json"
...
Cantonese may instantiate the structural family represented by NegativePotentialComplement; exact productivity and boundaries require pattern-specific independent evidence.
...
- Locator: author PDF section 2 summary, footnote 4, and section 4.3
- Verification: `VERIFIED_AUTHOR_FULL_TEXT_AND_PUBLISHER_METADATA`
- What it supports: Potential and permission/ability uses of 得 have different negative counterparts.
- Limit: Do not universalize the authors’ judgments beyond the reported variety and consultants.
...
- Standard executable test file: `tests/constructions/NegativePotentialComplement.json`
...
- Research question: Which externally documented Cantonese constructions, if any, justify the scope and boundaries currently represented by NegativePotentialComplement?
