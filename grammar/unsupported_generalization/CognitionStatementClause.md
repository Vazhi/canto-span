---
title: "CognitionStatementClause"
type: "canto-span-construction"
construction: "CognitionStatementClause"
...
standard_test_file: "tests/constructions/CognitionStatementClause.json"
...
Cantonese may instantiate the structural family represented by CognitionStatementClause; exact productivity and boundaries require pattern-specific independent evidence.
...
- Locator: abstract and section on implicit thought complements
- Verification: `VERIFIED_AUTHOR_ACCEPTED_PREPRINT`
- What it supports: Lui shows that mental-content complements can be left implicit under conversational/politeness conditions in a distinct construction.
- Limit: Do not transfer 心諗 selection or politeness properties to 知.
...
- What it supports: The bare negative example expresses not knowing with no overt object/content.
- Limit: Do not invent “it,” a prior question, or a specific fact in learner output.
...
- Standard executable test file: `tests/constructions/CognitionStatementClause.json`
...
- Research question: Which externally documented Cantonese constructions, if any, justify the scope and boundaries currently represented by CognitionStatementClause?
