...
- Implementation-only reachability: `STCWRAP-004` with `我叫做 Chris。`
- The probe protects the exact current 叫做 + ASCII-name fallback only. It does not resolve the checked-source split between personal 叫 and definitional or labeling 叫做.
