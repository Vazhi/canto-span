---
title: "IdentityWhQuestion"
type: "canto-span-construction"
construction: "IdentityWhQuestion"
...
standard_test_file: "tests/constructions/IdentityWhQuestion.json"
...
Cantonese may instantiate the structural family represented by IdentityWhQuestion; exact productivity and boundaries require pattern-specific independent evidence.
...
- Locator: book p. 66; 呢個咩嚟㗎
- Verification: `VERIFIED_FULL_TEXT`
- What it supports: The source attests demonstrative topic+wh complement+嚟+particle in an explanatory identity question.
- Limit: Do not use 呢個咩嚟㗎 as direct proof of exact 邊個嚟 or free 嚟 substitution.
...
- Locator: user PDF pp. 25 and 31; 嗰位小姐係邊個呀 and 邊位係黃先生呀
- Verification: `VERIFIED_USER_PROVIDED_FULL_TEXT_AND_OFFICIAL_PUBLISHER_METADATA`
- What it supports: The examples show both a known referent queried for identity and a wh person selected against a named referent.
- Limit: Do not collapse word order variants into one two-token fragment template.
...
- Standard executable test file: `tests/constructions/IdentityWhQuestion.json`
...
- Research question: Which externally documented Cantonese constructions, if any, justify the scope and boundaries currently represented by IdentityWhQuestion?
...
- Implementation-only reachability: `ESQWRAP-007` with `邊個嚟㗎？`
- Protects the current narrow 邊個 + 嚟 route only. Broader sourced identity-question patterns route differently.
