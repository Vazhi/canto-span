---
title: "QuantifiedPersonNP"
type: "canto-span-construction"
construction: "QuantifiedPersonNP"
...
standard_test_file: "tests/constructions/QuantifiedPersonNP.json"
...
- What it supports: Person nouns participate in nominal construction rather than requiring a separate syntax solely for animacy.
- Limit: Do not import the source’s semantic hierarchy as parser truth.
...
- Locator: pp. 437-441; Tables 1 and 3
- Verification: `VERIFIED_FULL_TEXT`
- What it supports: Nominal form does not itself determine subject, object, topic, or a fixed English quantifier reading.
- Limit: Do not hard-code subjecthood or a fixed translation into the NP node.
...
- Locator: pp. 6-11
- Verification: `VERIFIED_FULL_TEXT`
- What it supports: An overt 人 should remain the visible head; bare quantity or classifier ellipsis requires separate evidence.
- Limit: Do not license classifierless or headless forms by analogy.
...
- Locator: user PDF p. 119; additional occurrences throughout the coursebook
- Verification: `VERIFIED_USER_PROVIDED_FULL_TEXT_AND_OFFICIAL_PUBLISHER_METADATA`
- What it supports: 好多 modifies overt 人 in a contextualized Hong Kong Cantonese clause.
- Limit: Do not infer corpus frequency or a special person-only construction from textbook recurrence.
...
- Standard executable test file: `tests/constructions/QuantifiedPersonNP.json`
...
- Research question: Which externally documented Cantonese constructions, if any, justify the scope and boundaries currently represented by QuantifiedPersonNP?
