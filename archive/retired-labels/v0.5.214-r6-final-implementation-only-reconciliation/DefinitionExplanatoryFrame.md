---
title: "DefinitionExplanatoryFrame"
type: "canto-span-construction"
construction: "DefinitionExplanatoryFrame"
...
standard_test_file: "tests/constructions/DefinitionExplanatoryFrame.json"
...
> Retired in v0.5.214-r6: the exact wrapper was a source-free parser heuristic; its overt material remains compositional.

## Plain-language claim

Cantonese may instantiate the structural family represented by DefinitionExplanatoryFrame; exact productivity and boundaries require pattern-specific independent evidence.
...
- Standard executable test file: `tests/constructions/DefinitionExplanatoryFrame.json`
...
Implementation-only reachability: `LOWREF-002`. `圖書館係乜嘢嚟㗎。` reaches the bounded definition/explanatory wrapper. The probe has zero linguistic evidence weight.
