---
title: "CognitionDelimitedObjectVP"
type: "canto-span-construction"
construction: "CognitionDelimitedObjectVP"
...
standard_test_file: "tests/constructions/CognitionDelimitedObjectVP.json"
standard_test_coverage: "implementation_positive_only"
standard_positive_test_count: 0
standard_boundary_test_count: 0
standard_implementation_probe_count: 1
standard_executable_test_count: 1
source_ids: ["SRC-ALDERETE-ETAL-2017-SYNOPSIS", "SRC-SIO-BOND-2025", "SRC-ZHENG-ZHANG-GAO-2021-HK-CANTONESE-COURSE"]
runtime_active: true
...
Cantonese may instantiate the structural family represented by CognitionDelimitedObjectVP; exact productivity and boundaries require pattern-specific independent evidence.
...
- Locator: pp. 38-39 and 42; cognition predicates and clausal complements
- Verification: `VERIFIED_FULL_TEXT`
- What it supports: General cognition complementation is lexeme-sensitive and includes proposition-taking patterns.
- Limit: Do not create a cognition-predicate × arbitrary object cross-product.
...
- Locator: outer-aspect inventory and compatibility tables
- Verification: `VERIFIED_FULL_TEXT`
- What it supports: The aspect/delimitative evidence does not determine whether later material is object, content, adjunct, or separate clause.
- Limit: Do not derive transitivity from the aspect marker.
...
- Locator: printed p. 215: 你諗下係唔係
- Verification: `VERIFIED_USER_PROVIDED_FULL_TEXT_AND_OFFICIAL_PUBLISHER_METADATA`
- What it supports: Cognition-delimitative sequences can take content that is visibly clausal rather than nominal.
- Limit: Do not insert a hidden noun meaning “matter” or “idea”.
...
- Standard executable test file: `tests/constructions/CognitionDelimitedObjectVP.json`
...
- Research question: Which externally documented Cantonese constructions, if any, justify the scope and boundaries currently represented by CognitionDelimitedObjectVP?
...
- Implementation-only reachability: `EXPDEL-006`.
