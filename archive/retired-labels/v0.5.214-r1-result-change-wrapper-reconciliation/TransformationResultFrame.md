---
title: "TransformationResultFrame"
type: "canto-span-construction"
construction: "TransformationResultFrame"
...
standard_test_file: "tests/constructions/TransformationResultFrame.json"
...
Cantonese may instantiate the structural family represented by TransformationResultFrame; exact productivity and boundaries require pattern-specific independent evidence.
...
- What it supports: The frame should not conflate changed-state interpretation with perfective morphology.
- Limit: Do not label the entire clause resultative solely because it contains 咗.
...
- What it supports: Related forms support a broader change domain while requiring surface-strategy distinctions.
- Limit: Do not infer free paraphrase or identical complement selection.
...
- Standard executable test file: `tests/constructions/TransformationResultFrame.json`
...
- Research question: Which externally documented Cantonese constructions, if any, justify the scope and boundaries currently represented by TransformationResultFrame?
...
- Implementation-only reachability: `RESCHG-005A`.
