...
for (const probe of probes.cases) {
  ...
  check(`${probe.construction} note records CP038 zero-weight reachability`, note.includes("CP038 speech/transfer/complement wrapper audit") && note.includes(`\`${probe.case_id}\``) && note.includes("linguistic evidence weight is **0**"), notePath || "missing");
}
