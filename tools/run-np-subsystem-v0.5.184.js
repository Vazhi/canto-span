...
const matrix = JSON.parse(fs.readFileSync(path.join(root, "test-data", "np-subsystem-v0.5.184.json"), "utf8"));
const results = [];
...
const outputPath = path.join(root, "validation", "v0.5.184", "np-subsystem-results.json");
