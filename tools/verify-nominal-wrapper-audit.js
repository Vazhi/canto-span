...
check("test index has 36 implementation-positive-only labels", index.files.filter((r)=>r.state==="implementation_positive_only").length===36, index.files.filter((r)=>r.state==="implementation_positive_only").length);
...
check("test index has 29 no-direct labels", index.files.filter((r)=>r.state==="no_direct_cases").length===29, index.files.filter((r)=>r.state==="no_direct_cases").length);
