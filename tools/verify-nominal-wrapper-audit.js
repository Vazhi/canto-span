...
check("test index has 63 implementation-positive-only labels", index.files.filter((r)=>r.state==="implementation_positive_only").length===63, index.files.filter((r)=>r.state==="implementation_positive_only").length);
...
check("test index has zero no-direct labels", index.files.filter((r)=>r.state==="no_direct_cases").length===0, index.files.filter((r)=>r.state==="no_direct_cases").length);
