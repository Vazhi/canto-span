...
check("test index has 52 implementation-positive-only labels", index.files.filter((r)=>r.state==="implementation_positive_only").length===52, index.files.filter((r)=>r.state==="implementation_positive_only").length);
...
check("test index has 13 no-direct labels", index.files.filter((r)=>r.state==="no_direct_cases").length===13, index.files.filter((r)=>r.state==="no_direct_cases").length);
