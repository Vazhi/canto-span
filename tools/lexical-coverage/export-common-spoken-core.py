...
def build_outputs(cifu_path: Path):
    ...
    manifest = {
        ...
        "limitations": [
            "Corpus segmentation does not prove atomic lexicality.",
            "A common compositional sequence may be classified core_structural rather than receive an atomic runtime entry.",
            "A surface outside this 2,000-item priority core is not absent from Cantonese; it is simply lower priority for regression accommodation.",
            "Cifu definitions/Jyutping carry no independent lexical-semantic authority.",
            "The core should be expert-triaged for variants, proper names, transcript artifacts, and productive constructions before being treated as a final runtime requirement.",
        ],
    }
