...
This tool is intentionally narrow. The retirement ledger determines lexical invalidity;
...
LEDGER = ROOT / "data/lexical-frequency/r7-invalid-atomic-retirements.tsv"
    ...
    with LEDGER.open(encoding="utf-8", newline="") as fh:
        for row in csv.DictReader(fh, delimiter="\t"):
            ...
            if surface in targets:
                raise SystemExit(f"duplicate retirement surface: {surface}")
            targets[surface] = row
    return targets
